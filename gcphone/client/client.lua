...
--Opening of the phone linked to an item In solution EST based on the solution given by HalCroves
...
AddEventHandler('onClientResourceStart', function(res)
  DoScreenFadeIn(300)
  if res == "gcphone" then
    TriggerServerEvent('gcPhon:onPlayerLoaded', GetPlayerServerId(PlayerId()))
    Citizen.Wait(120000)
    TriggerServerEvent('gcPhon:onPlayerLoaded', GetPlayerServerId(PlayerId()))
  end
end)
