...
repairCfg = {
	...
	noFixMessages = {
		"You checked the oil plug. It's still there. Still used a hammer tho",
		"You looked at your engine, it seemed fine. Still used a hammer tho",
		"You made sure that the gaffer tape was still holding the engine together. Still used a hammer tho",
		"You turned up the radio volume. It just drowned out the weird engine noises. Still used a hammer tho",
		"You added rust-preventer to the spark tube. It made no difference. Still used a hammer tho",
		"Never fix something that ain't broken they said. You didn't listen. At least it didn't get worse. Still used a hammer tho"
	},
	noFixMessageCount = 6
}
