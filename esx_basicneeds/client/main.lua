	...
	if not IsAnimated then
		...
		Citizen.CreateThread(function()
			...
			ESX.Streaming.RequestAnimDict('mp_player_inteat@burger', function()
				TaskPlayAnim(playerPed, 'mp_player_inteat@burger', 'mp_player_int_eat_burger', 8.0, -8, 3000, 49, 0, 0, 0, 0)
...
RegisterNetEvent('esx_basicneeds:chocolate')
AddEventHandler('esx_basicneeds:chocolate', function(prop_name)
	if not IsAnimated then
	...
	if not IsAnimated then
		...
		Citizen.CreateThread(function()
			...
			ESX.Streaming.RequestAnimDict('amb@world_human_drinking@coffee@male@idle_a', function()
				TaskPlayAnim(playerPed, 'amb@world_human_drinking@coffee@male@idle_a', 'idle_a', 1.0, -1.0, 3000, 0, 1, true, true, true)
...
RegisterNetEvent('esx_basicneeds:beer')
AddEventHandler('esx_basicneeds:beer', function(prop_name)
	if not IsAnimated then
...
RegisterNetEvent('esx_basicneeds:bottlebeer')
AddEventHandler('esx_basicneeds:bottlebeer', function(prop_name)
	if not IsAnimated then
