...
RegisterNetEvent("brp_remap:useLaptop")
AddEventHandler("brp_remap:useLaptop", function()
    if not menu then
        TriggerServerEvent("brp_remap:removeItem")
...
RegisterNetEvent("brp_remap:closeMenu")
AddEventHandler("brp_remap:closeMenu",function()
    toggleMenu(false,true)
end)