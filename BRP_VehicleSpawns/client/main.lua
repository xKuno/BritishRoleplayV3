...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('brp_bumpercars:retrieveVehicles', function(vehicles)
...
TriggerServerEvent('brp_bumpercars:setVehicleTimer', vehicle, veh, minutes)
TriggerEvent('LegacyFuel:SetFuel', veh, 100.0)
end)
end

RegisterNetEvent('brp_bumpercars:deleteRentCar')
AddEventHandler('brp_bumpercars:deleteRentCar', function(entityId)
...
ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehiclesRentrent_this_veh',
	...
	function(data, menu)
        ...
        function (data2, menu2)
			...
			ESX.TriggerServerCallback('brp_bumpercars:buyVehicle', function(isBuyed)
				if isBuyed then 
				rentNoJob = rentNoJob + 1
	  ...
	  elseif not price then 
        ...
        function (data2, menu2)
			if data2.current.value == 'yes' then
			ESX.TriggerServerCallback('brp_bumpercars:getVehicle', function()
				rentJob = rentJob + 1
...
RegisterNetEvent('brp_bumpercars:respawnCars')
AddEventHandler('brp_bumpercars:respawnCars', function ()
ESX.TriggerServerCallback('brp_bumpercars:retrieveVehicles', function(vehicles)
