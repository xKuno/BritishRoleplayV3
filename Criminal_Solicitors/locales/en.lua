Locales['en'] = {
  -- I didn't removed outfits and this things bcuz i want you to check it first, and tell me what should i keep add or remove
  -- Cloackroom      
  ...
  ['Criminal_Solicitors_customer'] = 'Criminal Solicitors customer',
  -- Armory
