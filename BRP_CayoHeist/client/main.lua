...
RegisterNetEvent('brp_cayoheist:currentlyRobbing')
AddEventHandler('brp_cayoheist:currentlyRobbing', function(currentStore)
	holdingUp, store = true, currentStore
end)

RegisterNetEvent('brp_cayoheist:killBlip')
AddEventHandler('brp_cayoheist:killBlip', function()
	RemoveBlip(blipRobbery)
end)

RegisterNetEvent('brp_cayoheist:setBlip')
AddEventHandler('brp_cayoheist:setBlip', function(position)
...
RegisterNetEvent('brp_cayoheist:tooFar')
AddEventHandler('brp_cayoheist:tooFar', function()
	holdingUp, store = false, ''
	exports['mythic_notify']:DoCustomHudText('inform', _U('robbery_cancelled'))
end)

RegisterNetEvent('brp_cayoheist:robberyComplete')
AddEventHandler('brp_cayoheist:robberyComplete', function(award)
	holdingUp, store = false, ''
...
--end
RegisterNetEvent('brp_cayoheist:endTimer')
AddEventHandler('brp_cayoheist:endTimer', function()
	...
	Citizen.CreateThread(function()
		...
		GiveWeaponToPed(tugped1, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped2, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped3, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped4, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped5, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped6, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped7, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped8, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped9, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped10, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped11, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped12, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped13, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped14, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped15, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped16, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped17, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped18, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped19, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped20, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped21, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped22, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped23, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped24, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped25, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped26, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped27, GetHashKey('WEAPON_PISTOL'), 250, false, true)
		...
		GiveWeaponToPed(tugped28, GetHashKey('WEAPON_PISTOL'), 250, false, true)
...
--end
RegisterNetEvent('brp_cayoheist:startTimer')
AddEventHandler('brp_cayoheist:startTimer', function()
	local tugped2 = GetHashKey('g_m_y_salvaboss_01')
	local gun = GetHashKey('WEAPON_PISTOL')
	...
	while true do
				...
				if not holdingUp then
					...
					if distance < 0.5 then
						...
						if IsControlJustReleased(0, 38) then
							TriggerServerEvent('brp_cayoheist:robberyStarted', k)
						end
					end
				end
			end
		...
		if holdingUp then
			...
			if Vdist(playerPos.x, playerPos.y, playerPos.z, storePos.x, storePos.y, storePos.z) > Config.MaxDistance then
				TriggerServerEvent('brp_cayoheist:tooFar', store)
			end
		end
	end
end)
