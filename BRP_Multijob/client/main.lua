...
AddEventHandler(
    ...
    function(j)
        ...
        if Config.AllowAutoJobSavining then
            TriggerServerEvent("brp_multijob:checkForJob")
        end
    end
)
...
RegisterNUICallback(
    "removejob",
    function(data)
        TriggerServerEvent("brp_multijob:removeJob", data["job"], data["grade"])
    end
)
...
RegisterNUICallback(
    "changejob",
    function(data)
        TriggerServerEvent("brp_multijob:changeJob", data["job"], data["grade"])
    end
)
...
RegisterNetEvent("brp_multijob:sendMessage")
AddEventHandler(
    "brp_multijob:sendMessage",
    function(msg)
        SendTextMessage(msg)
    end
)
