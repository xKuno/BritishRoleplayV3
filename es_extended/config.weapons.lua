Config.Weapons = {
	...
	{
		name = 'WEAPON_WINCHESTER12BRP',
		label = _U('weapon_winchester12BRP'),
		components = {}
	},

	{
		name = 'WEAPON_UMP45BRP',
		label = _U('weapon_ump45BRP'),
		components = {}
	},

	{
		name = 'WEAPON_VESPERBRP',
		label = _U('weapon_vesperBRP'),
		components = {}
	},

	{
		name = 'WEAPON_PPSHBRP',
		label = _U('weapon_ppshBRP'),
		components = {}
	},

	{
		name = 'WEAPON_MP7BRP',
		label = _U('weapon_mp7BRP'),
		components = {}
	},

	{
		name = 'WEAPON_AUGBRP',
		label = _U('weapon_augBRP'),
		components = {}
	},

	{
		name = 'WEAPON_AK74KASHNARBRP',
		label = _U('weapon_ak74kashnarBRP'),
		components = {}
	},
	...
	{
		name = 'WEAPON_MP40',
		label = _U('weapon_mp40'),
		components = {}
	},

	{
		name = 'WEAPON_MAKAROV',
		label = _U('weapon_makarov'),
		components = {}
	},

	{
		name = 'WEAPON_TEC9BRP',
		label = _U('weapon_tec9BRP'),
		components = {}
	},

	{
		name = 'WEAPON_PYTHONBRP',
		label = _U('weapon_pythonbrp'),
		components = {}
	},
 
	{
		name = 'WEAPON_PT92',
		label = _U('weapon_pt92'),
		components = {}
	},

	{
		name = 'WEAPON_NAILGUN',
		label = _U('weapon_nailgun'),
		components = {}
	},

	{
		name = 'WEAPON_M1911BRP',
		label = _U('weapon_m1911BRP'),
		components = {}
	},

	{
		name = 'WEAPON_HK45BRP',
		label = _U('weapon_hk45BRP'),
		components = {}
	},
	...
	{
		name = 'WEAPON_GUITARBRP',
		label = _U('weapon_guitarBRP'),
		components = {}
	},

	{
		name = 'WEAPON_SHOVELBRP',
		label = _U('weapon_shovelBRP'),
		components = {}
	},

	{
		name = 'WEAPON_FIREAXEBRP',
		label = _U('weapon_fireaxeBRP'),
		components = {}
	},

	{
		name = 'WEAPON_DILDOBRP',
		label = _U('weapon_dildoBRP'),
		components = {}
	},

	{
		name = 'WEAPON_CLEAVERBRP',
		label = _U('weapon_cleaverBRP'),
		components = {}
	},

	{
		name = 'WEAPON_BROOMBRP',
		label = _U('weapon_broomBRP'),
		components = {}
	},

	{
		name = 'WEAPON_VECTORBRP',
		label = _U('weapon_vectorBRP'),
		components = {}
	},
 
	{
		name = 'WEAPON_TAR21',
		label = _U('weapon_tar21'),
		components = {}
	},

	{
		name = 'WEAPON_SCARLBRP',
		label = _U('weapon_scarlBRP'),
		components = {}
	},
	...
	{
		name = 'WEAPON_MOSINBRP',
		label = _U('weapon_mosinBRP'),
		components = {}
	},

	{
		name = 'WEAPON_MAKAROVBRP',
		label = _U('weapon_makarovBRP'),
		components = {}
	},

	{
		name = 'WEAPON_AKMBRP',
		label = _U('weapon_akmbrp'),
		components = {}
	},

	{
		name = 'WEAPON_AK74KASHNAR',
		label = _U('weapon_ak74kashnar'),
		components = {}
	},

	{
		name = 'WEAPON_AK74BRP',
		label = _U('weapon_ak74brp'),
		components = {}
	},

	{
		name = 'WEAPON_SIGMPX',
		label = _U('weapon_sigmpx'),
		components = {}
	},

	{
		name = 'WEAPON_REMINGTON870BRP',
		label = _U('weapon_remington870BRP'),
		components = {}
	},

	{
		name = 'WEAPON_RE6BRP',
		label = _U('weapon_re6brp'),
		components = {}
	},

	{
		name = 'WEAPON_M110BRP',
		label = _U('weapon_m110BRP'),
		components = {}
	},
	...
	{
		name = 'WEAPON_HK870',
		label = _U('weapon_hk870'),
		components = {}
	},

	{
		name = 'WEAPON_GLOCKBRP',
		label = _U('weapon_glockBRP'),
		components = {
	...
	{
		name = 'WEAPON_NA2BRP',
		label = _U('weapon_na2BRP'),
		components = {}
	},

	{
		name = 'WEAPON_SIGBRP',
		label = _U('weapon_sigBRP'),
		components = {}
	},

	{
		name = 'WEAPON_SCARBRP',
		label = _U('weapon_scarBRP'),
		components = {}
	},

	{
		name = 'WEAPON_M16A4',
		label = _U('weapon_m16a4'),
		components = {}
	},

	{
		name = 'WEAPON_LVOACBRP',
		label = _U('weapon_lvoacBRP'),
		components = {
	...
	{
		name = 'WEAPON_CONCUSSIONRIFLE',
		label = _U('weapon_concussionrifle'),
		components = {}
	},

	{
		name = 'WEAPON_RAINBOWGUN',
		label = _U('weapon_rainbowgun'),
		components = {}
	},

	{
		name = 'WEAPON_NEEDLERRIFLE',
		label = _U('weapon_needlerrifle'),
		components = {}
	},

	{
		name = 'WEAPON_PLASMAP',
		label = _U('weapon_plasmap'),
		components = {}
	},

	{
		name = 'WEAPON_SPLASER',
		label = _U('weapon_splaser'),
		components = {}
	},
	...
	{
		name = 'WEAPON_M4A4',
		label = _U('weapon_m4a4'),
		components = {}
	},

	{
		name = 'WEAPON_RAYGUN',
		label = _U('weapon_raygun'),
		components = {}
	},

	{
		name = 'WEAPON_NEEDLER',
		label = _U('weapon_needler'),
		components = {}
	},

	{
		name = 'WEAPON_PLASMA',
		label = _U('weapon_plasma'),
		components = {}
	},

	{
		name = 'WEAPON_THUNDERGUN',
		label = _U('weapon_thundergun'),
		components = {}
	},

	{
		name = 'WEAPON_UNMAYKR',
		label = _U('weapon_unmaykr'),
		components = {}
	},

	{
		name = 'WEAPON_BFG9000MK2',
		label = _U('weapon_bfg9000mk2'),
		components = {}
	},

	{
		name = 'WEAPON_BFG9000',
		label = _U('weapon_bfg9000'),
		components = {}
	},

	{
		name = 'WEAPON_BOLTOCK',
		label = _U('weapon_boltock'),
		components = {}
	},

	{
		name = 'WEAPON_RAYSHOTGUN',
		label = _U('weapon_rayshotgun'),
		components = {}
	},

	{
		name = 'WEAPON_HEAVYRAYGUN',
		label = _U('weapon_heavyraygun'),
		components = {}
	},
	...
	{
		name = 'WEAPON_VESPER',
		label = _U('weapon_vesper'),
		components = {}
	},

	{
		name = 'WEAPON_LUGER',
		label = _U('weapon_luger'),
		components = {}
	},

	{
		name = 'WEAPON_DEAGLE',
		label = _U('weapon_deagle'),
		components = {}
	},

	{
		name = 'WEAPON_GRS7RG98',
		label = _U('weapon_grs7rg98'),
		components = {}
	},

	{
		name = 'WEAPON_PPSH',
		label = _U('weapon_ppsh'),
		components = {}
	},
	...
	{
		name = 'WEAPON_RAZORBACK',
		label = _U('weapon_razorback'),
		components = {}
	},
	...
	{
		name = 'WEAPON_SCARH',
		label = _U('weapon_scarh'),
		components = {}
	},

	{
		name = 'WEAPON_AK47NEON',
		label = _U('weapon_ak47neon'),
		components = {}
	},
...

	{
		...
		label = _U('weapon_springfield'),
		components = {}
	},

	{
		name = 'WEAPON_BLASTER',
		label = _U('weapon_blaster'),
		components = {}
	},

	{
		name = 'WEAPON_UMP45',
		label = _U('weapon_ump45'),
		components = {}
	},

	{
		name = 'WEAPON_VECTOR',
		label = _U('weapon_vector'),
		components = {}
	},
