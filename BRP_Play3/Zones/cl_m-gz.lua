...
Greenzones = { -- Add your greenzones here. Do not forget the comma!
    ["JobCentre"] = { Coords = vector3(-528.4,-214.18,37.65), Radius = 80.0 },
    ["Legion"] = { Coords = vector3(200.77,-928.84,30.69), Radius = 120.0 },
    ["Rs"] = { Coords = vector3(-794.11,-218.34,36.0), Radius = 80.0 },
    ["Hospital"] = { Coords = vector3(335.36,-585.93,27.79), Radius = 120.0 }
  }
...
function EnteredGreenzone()
   ...
   TriggerEvent('chat:addMessage', {
       color = { 255, 0, 0},
       multiline = true,
       args = {"British Roleplay", "You entered the greenzone"}})
...
function LeftGreenzone()
   ...
   TriggerEvent('chat:addMessage', {
       color = { 255, 0, 0},
       multiline = true,
       args = {"British Roleplay", "You left the greenzone"}})  
    PlaySound(-1, "CHARACTER_CHANGE_CHARACTER_01_MASTER", 0, 0, 0, 0)
    --SetEntityMaxSpeed(GetVehiclePedIsIn(GetPlayerPed(-1), false),speedNotInGZ)
    isLeaveMessagePresent = true
    Citizen.SetTimeout(leaveMessage, function() -- Wait the timer to be done
