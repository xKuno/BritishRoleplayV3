...
local voice = {default = 7.5, shout = 15.0, whisper = 30.0, current = 0, level = nil}
...
function drawLevel(r, g, b, a)
	...
	EndTextCommandDisplayText(0.02, 0.97)
end
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustPressed(1, Keys['=']) and IsControlPressed(1, Keys['LEFTSHIFT']) then
