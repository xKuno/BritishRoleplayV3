Locales['en'] = {
  ...
  ['car_dealer']              = 'Bike Dealer',
  ['shop_awaiting_model']     = 'the vehicle is currently loading, please wait',
  ['create_bill']             = 'create bill',
  ['get_bikerented_vehicles'] = 'Vehicles for rent',
  ['dealer_boss']             = 'Bike Dealer - Boss',
  ...
  ['rent_vehicle']            = 'Bike Dealer - Vehicles for rent',
  ['return_provider_menu']    = 'Bike Dealer - Return vehicle to provider',
  ...
  ['generic_shopitem']        = '$%s',
  ['vehicle_dealer']          = 'vehicle - Bike Dealer',
  ...
  ['customer_model']          = 'Bike model',
  ['customer_plate']          = 'Bike plate',
