		...
		if data.current.value == 'vehicle_list' then
			if Config.EnableSocietyOwnedVehicles then
				...
				local elements = {
					...
					{label = _U('KwikFitVan'),  value = 'KwikFitVan'},
		...
		elseif data.current.value == 'dep_vehicle' then
			...
			if isVehicleTow then
				...
				if CurrentlyTowedVehicle == nil then
					if targetVehicle ~= 0 then
						if not IsPedInAnyVehicle(playerPed, true) then
							if vehicle ~= targetVehicle then
								--AttachEntityToEntity(targetVehicle, vehicle, 17, 1.2, -5.0, 1.0, 0.0, 0.0, 0.0, false, false, false, false, 20, true)--Little AA FlatBed
								AttachEntityToEntity(targetVehicle, vehicle, 17, 0.8, 4.5, 1.0, 0.0, 0.0, 0.0, false, false, false, false, 20, true)--Big AA FlatBed
					...
					--AttachEntityToEntity(CurrentlyTowedVehicle, vehicle, 20, -0.5, -5.0, 1.0, 0.0, 0.0, 0.0, false, false, false, false, 20, true)--Little AA FlatBed
					AttachEntityToEntity(CurrentlyTowedVehicle, vehicle, 17, 0.8, -5.0, 1.0, 0.0, 0.0, 0.0, false, false, false, false, 20, true)--Big AA FlatBed
		...
		elseif data.current.value == 'object_spawner' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_mechanic_actions_spawn', {
				...
				elements = {
					...
					{label = _U('toolbox'),  value = 'prop_toolchest_02'},
					{label = _U('toolboxmedium'), value = 'prop_toolchest_03'},
					{label = _U('toolboxlarge'),  value = 'prop_toolchest_05'}
				...
				if model == 'prop_roadcone02a' then
					z = z - 2.0
				elseif model == 'prop_toolchest_02' then
					z = z - 2.0
				elseif model == 'prop_toolchest_03' then
					z = z - 2.0
...
RegisterNetEvent('esx_mechanicjob:onCarokitems')
AddEventHandler('esx_mechanicjob:onCarokitems', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
				...
				elseif CurrentAction == 'delete_vehicle' then
					...
					if Config.EnableSocietyOwnedVehicles then
						...
						if
							...
							GetEntityModel(vehicle) == GetHashKey('KwikFitVan') or
