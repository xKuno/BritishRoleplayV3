...
Config.NPCJobEarnings             = { min = 150, max = 750 }
...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -214.96, y = -1318.86, z = 30.89 },
	...
	VehicleDelivery = {
		Pos   = { x = 2193.34, y = 2918.97, z = 45.44 },
