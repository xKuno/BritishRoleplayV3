...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(1, 163) and self.group == "superadmin" then	
				TriggerEvent('esx_spectate:spectae')
		end
	end
end)
...
RegisterNetEvent('esx_spectate:spectae')
AddEventHandler('esx_spectate:spectae', function()
