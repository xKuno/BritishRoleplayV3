Citizen.CreateThread(function()
	while true do
		SetDiscordAppId(702616481275314226) --Discord app id
		SetDiscordRichPresenceAsset('bg-1') --Big picture asset name
        SetDiscordRichPresenceAssetText('British Roleplay') --Big picture hover text
        SetDiscordRichPresenceAssetSmall('brpv2') --Small picture asset name
        SetDiscordRichPresenceAssetSmallText('BRP') --Small picture hover text
