WeaponNames = {
			   ...
			   [tostring(GetHashKey('WEAPON_akmBRP'))] = 'GOLD AK',
			   [tostring(GetHashKey('WEAPON_FNP'))] = 'FNP',
			   [tostring(GetHashKey('WEAPON_PT92'))] = 'PT',
			   [tostring(GetHashKey('WEAPON_vectorBRP'))] = 'vector',
			   [tostring(GetHashKey('WEAPON_WINCHESTER12BRP'))] = 'WINCHESTER',
