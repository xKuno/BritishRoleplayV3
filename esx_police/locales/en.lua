Locales['en'] = {
  ...
  ['vehicleshop_awaiting_model'] = 'wait for the vehicle to load',
  ['confirm_no'] = 'no',
  ['confirm_yes'] = 'yes',
  -- Service
  ...
  ['cone'] = 'Small Cone',
  ['bigcone'] = 'Big Cone',
  ['barrier'] = 'Road Closed Sign',
  ['barrier2'] = 'Police Slow Sign',
  ['spikestrips'] = 'Stinger',
  ['barrier3'] = 'Concrete barrier',
  ...
  -- Notifications
  ['alert_police'] = 'Police Officer alert',
  ['phone_police'] = 'police',
