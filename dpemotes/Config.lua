...
-- Set this if you really wanna disable emotes in cars, as of 1.7.2 they only play the upper body part if in vehicle
    AllowedInCars = true,
-- You can disable the (Z) menu here / change the keybind.
	MenuKeybindEnabled = true,
	MenuKeybind = 20, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/ZDq0d2N.jpg", --https://i.imgur.com/kgzvDwQ.png",https://imgur.com/MrD7tm6  https://imgur.com/MrD7tm6 https://i.imgur.com/MrD7tm6.png
